...
(define-key 'buffer-menu (kbd #\m) 'buffer-menu-mark)
(define-key 'buffer-menu (kbd #\q) 'buffer-menu-quit)
(define-key 'buffer-menu (kbd #\1) 'buffer-menu-1-window)
(define-key 'buffer-menu (kbd #\2) 'buffer-menu-2-window)
(define-key 'buffer-menu (kbd #\f) 'buffer-menu-this-window)
(define-key 'buffer-menu (kbd #\o) 'buffer-menu-other-window)
(define-key 'buffer-menu (kbd #\~) 'buffer-menu-not-modified)
(define-key 'buffer-menu (kbd #\s) 'buffer-menu-save)
(define-key 'buffer-menu (kbd #\d) 'buffer-menu-delete)
(define-key 'buffer-menu (kbd #\k) 'buffer-menu-delete)
(define-key 'buffer-menu (kbd (ctrl d)) 'buffer-menu-delete-backwards)
(define-key 'buffer-menu (kbd (ctrl k)) 'buffer-menu-delete)
(define-key 'buffer-menu (kbd #\x) 'buffer-menu-execute)
(define-key 'buffer-menu (kbd #\u) 'buffer-menu-unmark)
(define-key 'buffer-menu (kbd rubout) 'buffer-menu-backup-unmark)
(define-key 'buffer-menu (kbd space) 'buffer-menu-next-line)
(define-key 'buffer-menu (kbd (ctrl #\])) 'buffer-menu-abort)
(define-key 'buffer-menu (kbd #\?) 'describe-mode)

