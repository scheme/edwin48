...
(define-key 'continuation-browser (kbd (meta o))
  'undefined)

;;; Comint History
(define-key 'continuation-browser (kbd (meta p))
  'comint-previous-input)
(define-key 'continuation-browser (kbd (meta n))
  'comint-next-input)
(define-key 'continuation-browser (kbd (ctrl #\c) (ctrl #\r))
  'comint-history-search-backward)
(define-key 'continuation-browser (kbd (ctrl #\c) (ctrl #\s))
  'comint-history-search-forward)

;;; Evaluation Commands
(define-key 'continuation-browser (kbd (ctrl #\x) (ctrl #\e))
  'continuation-browser-eval-last-sexp)
(define-key 'continuation-browser (kbd (ctrl #\x) (ctrl #\r))
  'continuation-browser-eval-last-sexp/dynamic)
(define-key 'continuation-browser (kbd (meta #\z))
  'continuation-browser-eval-defun)
(define-key 'continuation-browser (kbd meta ctrl #\z)
  'continuation-browser-eval-region)

;;; Motion Commands
(define-key 'continuation-browser (kbd (ctrl #\c) (ctrl #\f))
  'continuation-browser-forward-reduction)
(define-key 'continuation-browser (kbd (ctrl #\c) (ctrl #\n))
  'continuation-browser-forward-subproblem)
(define-key 'continuation-browser (kbd (ctrl #\c) (ctrl #\b))
  'continuation-browser-backward-reduction)
(define-key 'continuation-browser (kbd (ctrl #\c) (ctrl #\p))
  'continuation-browser-backward-subproblem)
(define-key 'continuation-browser (kbd (ctrl #\c) (ctrl #\w))
  'continuation-browser-go-to)

;;; Information-display Commands
(define-key 'continuation-browser (kbd (ctrl #\c) (ctrl #\a))
  'continuation-browser-show-all-frames)
(define-key 'continuation-browser (kbd (ctrl #\c) (ctrl #\c))
  'continuation-browser-show-current-frame)
(define-key 'continuation-browser (kbd (ctrl #\c) (ctrl #\e))
  'continuation-browser-print-environment)
(define-key 'continuation-browser (kbd (ctrl #\c) (ctrl #\l))
  'continuation-browser-print-expression)
(define-key 'continuation-browser (kbd (ctrl #\c) (ctrl #\o))
  'continuation-browser-print-environment-procedure)
(define-key 'continuation-browser (kbd (ctrl #\c) (ctrl #\m))
  'continuation-browser-expand-reductions)
(define-key 'continuation-browser (kbd (ctrl #\c) (ctrl #\t))
  'continuation-browser-print-subproblem-or-reduction)
(define-key 'continuation-browser (kbd (ctrl #\c) (ctrl #\x))
  'continuation-browser-expand-subproblems)
(define-key 'continuation-browser (kbd (ctrl #\c) (ctrl #\y))
  'continuation-browser-frame)

;;; Miscellaneous Commands
(define-key 'continuation-browser (kbd (ctrl #\c) (ctrl #\k))
  'continuation-browser-condition-restart)
(define-key 'continuation-browser (kbd (ctrl #\c) (ctrl #\j))
  'continuation-browser-return-to)
(define-key 'continuation-browser (kbd (ctrl #\c) (ctrl #\z))
  'continuation-browser-return-from)
(define-key 'continuation-browser (kbd (ctrl #\c) (ctrl #\d))
  'continuation-browser-retry)
(define-key 'continuation-browser (kbd (ctrl #\c) (ctrl #\g))
  'continuation-browser-abort-all)
(define-key 'continuation-browser (kbd (ctrl #\c) (ctrl #\u))
  'continuation-browser-abort-previous)
(define-key 'continuation-browser (kbd (ctrl #\c) (ctrl meta #\y))
...
(define (continuation-browser-abort restarts)
  (let ((restart
	 (find (lambda (restart) (eq? (restart/name restart) 'abort))
	       restarts)))
    (if (not restart)
