...
(define-key 'info (kbd space) 'scroll-up)
(define-key 'info (kbd #\.) 'beginning-of-buffer)
(define-key 'info (kbd return) 'info-current-menu-item)
(define-key 'info (kbd tab) 'info-find-next-reference)
(define-key 'info (kbd (meta tab)) 'info-find-previous-reference)
(define-key 'info (kbd #\1) 'info-first-menu-item)
(define-key 'info (kbd #\2) 'info-second-menu-item)
(define-key 'info (kbd #\3) 'info-third-menu-item)
(define-key 'info (kbd #\4) 'info-fourth-menu-item)
(define-key 'info (kbd #\5) 'info-fifth-menu-item)
(define-key 'info (kbd #\?) 'info-summary)
(define-key 'info (kbd #\b) 'beginning-of-buffer)
(define-key 'info (kbd #\d) 'info-directory)
(define-key 'info (kbd #\e) 'info-edit)
(define-key 'info (kbd #\f) 'info-follow-reference)
(define-key 'info (kbd #\g) 'info-goto-node)
(define-key 'info (kbd #\h) 'info-help)
(define-key 'info (kbd #\l) 'info-last)
(define-key 'info (kbd #\m) 'info-menu)
(define-key 'info (kbd #\n) 'info-next)
(define-key 'info (kbd #\p) 'info-previous)
(define-key 'info (kbd #\q) 'info-exit)
(define-key 'info (kbd #\s) 'info-search)
(define-key 'info (kbd #\u) 'info-up)
(define-key 'info (kbd rubout) 'scroll-down)

;;;; Motion
...
(define-key 'info-edit (kbd (ctrl c) (ctrl c)) 'info-cease-edit)
