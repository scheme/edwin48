...
(define-key 'news-common (kbd #\a) 'news-compose-article)
(define-key 'news-common (kbd #\O) 'news-toggle-online)
(define-key 'news-common (kbd #\q) 'news-kill-current-buffer)
(define-key 'news-common (kbd #\m) 'mail)
(define-key 'news-common (kbd #\?) 'describe-mode)
(define-key 'news-common (kbd (ctrl #\x) (ctrl #\s)) 'news-save-server-data)
...
(define-key 'news-server (kbd space) 'news-select-group)
(define-key 'news-server (kbd #\g) 'news-read-subscribed-group-headers)
(define-key 'news-server (kbd (meta #\g)) 'news-read-group-headers)
(define-key 'news-server (kbd #\G) 'news-refresh-groups)
(define-key 'news-server (kbd (meta #\G)) 'news-refresh-group)
(define-key 'news-server (kbd #\l) 'news-all-groups)
(define-key 'news-server (kbd #\n) 'news-new-groups)
(define-key 'news-server (kbd #\r) 'news-read-marked-bodies)
(define-key 'news-server (kbd #\s) 'news-subscribe-group)
(define-key 'news-server (kbd (meta s)) 'news-subscribe-group-by-name)
(define-key 'news-server (kbd #\u) 'news-unsubscribe-group)
(define-key 'news-server (kbd rubout) 'news-unsubscribe-group-backwards)

...
(define-key 'news-group (kbd space) 'news-select-article)
(define-key 'news-group (kbd #\c) 'news-catch-up-group)
(define-key 'news-group (kbd (meta #\c)) 'news-collapse-threads)
(define-key 'news-group (kbd #\d) 'news-delete-article)
(define-key 'news-group (kbd (meta #\d)) 'news-delete-thread)
(define-key 'news-group (kbd (meta #\e)) 'news-expand-threads)
(define-key 'news-group (kbd #\g) 'news-revert-group)
(define-key 'news-group (kbd #\h) 'news-group-show-header)
(define-key 'news-group (kbd #\i) 'news-ignore-thread)
(define-key 'news-group (kbd #\m) 'news-mark-article)
(define-key 'news-group (kbd (meta #\m)) 'news-mark-thread)
(define-key 'news-group (kbd #\n) 'news-group-next-unread-header)
(define-key 'news-group (kbd #\N) 'news-group-next-unread-article)
(define-key 'news-group (kbd (meta #\n)) 'news-group-next-thread)
(define-key 'news-group (kbd (meta #\N)) 'news-group-next-thread-article)
(define-key 'news-group (kbd #\o) 'news-output-article-to-rmail-file)
(define-key 'news-group (kbd (ctrl #\o)) 'news-output-article)
(define-key 'news-group (kbd #\p) 'news-group-previous-unread-header)
(define-key 'news-group (kbd #\P) 'news-group-previous-unread-article)
(define-key 'news-group (kbd (meta #\p)) 'news-group-previous-thread)
(define-key 'news-group (kbd (meta #\P)) 'news-group-previous-thread-article)
(define-key 'news-group (kbd #\q) 'news-group-quit)
(define-key 'news-group (kbd #\r) 'news-read-marked-bodies)
(define-key 'news-group (kbd #\s) 'news-group-show-subject)
(define-key 'news-group (kbd #\t) 'news-toggle-thread)
(define-key 'news-group (kbd #\u) 'news-unmark-article)
(define-key 'news-group (kbd (meta #\u)) 'news-unmark-thread)
(define-key 'news-group (kbd #\x) 'news-expunge-group)
(define-key 'news-group (kbd #\rubout) 'news-unmark-article-backwards)
...
(define-key 'news-article (kbd #\space) '(news-article . (kbd (ctrl #\v))))
(define-key 'news-article (kbd #\rubout) '(news-article . (kbd (meta v))))
(define-key 'news-article (kbd #\c) 'news-toggle-article-context)
(define-key 'news-article (kbd #\d) 'news-next-article)
(define-key 'news-article (kbd #\D) 'news-next-article-in-thread)
(define-key 'news-article (kbd #\f) 'news-forward-article)
(define-key 'news-article (kbd #\i) 'news-ignore-article-thread)
(define-key 'news-article (kbd #\n) 'news-next-unread-article)
(define-key 'news-article (kbd #\N) 'news-next-unread-article-in-thread)
(define-key 'news-article (kbd (meta #\n)) 'news-next-thread-article)
(define-key 'news-article (kbd #\o) 'news-output-article-to-rmail-file)
(define-key 'news-article (kbd (ctrl #\o)) 'news-output-article)
(define-key 'news-article (kbd #\p) 'news-previous-unread-article)
(define-key 'news-article (kbd #\P) 'news-previous-unread-article-in-thread)
(define-key 'news-article (kbd (meta #\p)) 'news-previous-thread-article)
(define-key 'news-article (kbd #\r) 'news-reply-to-article)
(define-key 'news-article (kbd #\R) 'news-compose-followup-article)
(define-key 'news-article (kbd #\t) 'news-toggle-article-header)
(define-key 'news-article (kbd #\u) 'news-previous-article)
(define-key 'news-article (kbd #\U) 'news-previous-article-in-thread)

...
(define-key 'compose-news (kbd (ctrl #\c) (ctrl #\f) (ctrl #\a)) 'news-move-to-summary)
(define-key 'compose-news (kbd (ctrl #\c) (ctrl #\f) (ctrl #\d)) 'news-move-to-distribution)
(define-key 'compose-news (kbd (ctrl #\c) (ctrl #\f) (ctrl #\f)) 'news-move-to-followup-to)
(define-key 'compose-news (kbd (ctrl #\c) (ctrl #\f) (ctrl #\k)) 'news-move-to-keywords)
(define-key 'compose-news (kbd (ctrl #\c) (ctrl #\f) (ctrl #\n)) 'news-move-to-newsgroups)
...
(define (canonicalize-ranges ranges)
  (if (null? ranges)
      ranges
      (let ((ranges
	     (list-sort (lambda (x y) (< (range-first x) (range-first y))) ranges)))
