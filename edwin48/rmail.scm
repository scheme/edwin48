...
(define (parse-comma-list start end)
  (let loop ((start start))
	...
	(cons (extract-string start (skip-chars-backward " " m start))
		  ...
		  '()))))))

(define-key 'rmail (kbd #\.)		'beginning-of-buffer)
(define-key 'rmail (kbd #\space)	'scroll-up)
(define-key 'rmail (kbd #\rubout)	'scroll-down)
(define-key 'rmail (kbd #\n)		'rmail-next-undeleted-message)
(define-key 'rmail (kbd #\p)		'rmail-previous-undeleted-message)
(define-key 'rmail (kbd (meta #\n))	'rmail-next-message)
(define-key 'rmail (kbd (meta #\p))	'rmail-previous-message)
(define-key 'rmail (kbd ctrl meta #\n))	'rmail-next-labeled-message)
(define-key 'rmail (kbd ctrl meta #\p))	'rmail-previous-labeled-message)
(define-key 'rmail (kbd #\a)		'rmail-add-label)
(define-key 'rmail (kbd #\k)		'rmail-kill-label)
(define-key 'rmail (kbd #\d)		'rmail-delete-forward)
(define-key 'rmail (kbd #\u)		'rmail-undelete-previous-message)
(define-key 'rmail (kbd #\e)		'rmail-expunge)
(define-key 'rmail (kbd #\x)		'rmail-expunge)
(define-key 'rmail (kbd #\s)		'rmail-expunge-and-save)
(define-key 'rmail (kbd #\g)		'rmail-get-new-mail)
(define-key 'rmail (kbd #\h)		'rmail-summary)
(define-key 'rmail (kbd ctrl meta #\h))	'rmail-summary)
(define-key 'rmail (kbd #\l)		'rmail-summary-by-labels)
(define-key 'rmail (kbd ctrl meta #\l))	'rmail-summary-by-labels)
(define-key 'rmail (kbd ctrl meta #\r))	'rmail-summary-by-recipients)
(define-key 'rmail (kbd #\t)		'rmail-toggle-header)
(define-key 'rmail (kbd #\m)		'rmail-mail)
(define-key 'rmail (kbd #\r)		'rmail-reply)
(define-key 'rmail (kbd #\c)		'rmail-continue)
(define-key 'rmail (kbd #\f)		'rmail-forward)
(define-key 'rmail (kbd (meta #\s))	'rmail-search)
(define-key 'rmail (kbd #\j)		'rmail-show-message)
(define-key 'rmail (kbd #\o)		'rmail-output-to-rmail-file)
(define-key 'rmail (kbd (ctrl #\o))	'rmail-output)
(define-key 'rmail (kbd #\i)		'rmail-input)
(define-key 'rmail (kbd #\q)		'rmail-quit)
(define-key 'rmail (kbd #\>)		'rmail-last-message)
(define-key 'rmail (kbd #\?)		'describe-mode)
(define-key 'rmail (kbd #\w)		'rmail-edit-current-message)
(define-key 'rmail (kbd (ctrl #\d))	'rmail-delete-backward)

(define-key 'rmail-edit (kbd (ctrl #\c) (ctrl #\c)) 'rmail-cease-edit)
(define-key 'rmail-edit (kbd (ctrl #\c) (ctrl #\])) 'rmail-abort-edit)

...
If not false, this server is used to initialize rmail-primary-inbox-list.
