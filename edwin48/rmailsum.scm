...
(define-key 'rmail-summary (kbd #\j)		'rmail-summary-show-message)
(define-key 'rmail-summary (kbd #\n)		'rmail-summary-next-undeleted-message)
(define-key 'rmail-summary (kbd #\p)
  'rmail-summary-previous-undeleted-message)
(define-key 'rmail-summary (kbd (meta #\n))	'rmail-summary-next-message)
(define-key 'rmail-summary (kbd (meta #\p))	'rmail-summary-previous-message)
(define-key 'rmail-summary (kbd ctrl meta #\n)	'rmail-summary-next-labeled-message)
(define-key 'rmail-summary (kbd ctrl meta #\p)
  'rmail-summary-previous-labeled-message)
(define-key 'rmail-summary (kbd space)	'rmail-summary-scroll-message-up)
(define-key 'rmail-summary (kbd rubout)	'rmail-summary-scroll-message-down)
(define-key 'rmail-summary (kbd #\d)		'rmail-summary-delete-message-forward)
(define-key 'rmail-summary (kbd #\D)    	'rmail-summary-delete-message-backward)
(define-key 'rmail-summary (kbd (meta #\d))        'rmail-summary-delete-message)
(define-key 'rmail-summary (kbd #\u)
  'rmail-summary-undelete-message-backward)
(define-key 'rmail-summary (kbd #\U)
  'rmail-summary-undelete-message-forward)
(define-key 'rmail-summary (kbd (meta #\u))	'rmail-summary-undelete-message)
(define-key 'rmail-summary (kbd #\q)		'rmail-summary-quit)
(define-key 'rmail-summary (kbd #\x)		'rmail-summary-exit)
(define-key 'rmail-summary (kbd #\.)		'rmail-summary-beginning-of-buffer)
(define-key 'rmail-summary (kbd #\e)		'rmail-summary-expunge)
(define-key 'rmail-summary (kbd #\s)		'rmail-summary-expunge-and-save)
(define-key 'rmail-summary (kbd #\t)		'rmail-summary-toggle-header)
(define-key 'rmail-summary (kbd (ctrl o))	'rmail-summary-output)
(define-key 'rmail-summary (kbd #\o)		'rmail-summary-output-to-rmail-file)
(define-key 'rmail-summary (kbd #\g)		'rmail-summary-get-new-mail)
(define-key 'rmail-summary (kbd #\i)		'rmail-summary-input)
(define-key 'rmail-summary (kbd #\?)		'describe-mode)
(define-key 'rmail-summary (kbd #\m)		'rmail-summary-mail)
(define-key 'rmail-summary (kbd #\r)		'rmail-summary-reply)

;;; (define-key 'rmail (kbd #\a)		'rmail-add-label)
;;; (define-key 'rmail (kbd #\k)		'rmail-kill-label)
;;; (define-key 'rmail (kbd #\l)		'rmail-summary-by-labels)
;;; (define-key 'rmail (kbd #\c)		'rmail-continue)
;;; (define-key 'rmail (kbd (meta #\s))	        'rmail-search)
;;; (define-key 'rmail (kbd #\>)		'rmail-last-message)
;;; (define-key 'rmail (kbd #\w)		'rmail-edit-current-message)

