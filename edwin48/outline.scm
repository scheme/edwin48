...
(define-key 'outline (kbd (ctrl #\c) (ctrl #\f)) 'forward-topic)
(define-key 'outline (kbd (ctrl #\c) (ctrl #\b)) 'backward-topic)
(define-key 'outline (kbd (ctrl #\c) (ctrl #\n)) 'narrow-to-topic)
(define-key 'outline (kbd (ctrl #\c) (ctrl #\a)) 'forward-up-topic)
(define-key 'outline (kbd (ctrl #\c) (ctrl #\u)) 'backward-up-topic)
(define-key 'outline (kbd (ctrl #\c) (ctrl #\d)) 'forward-down-topic)